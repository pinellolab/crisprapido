...
DEFAULT_RUN_ID = "chr2_100_guides_correctness_20260812T142104Z"
...
def batch_for_guide(guide_id):
    ...
    return f"batch_{((ordinal - 1) // 10) + 1:03d}"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run chr2_100 biological-locus correctness oracle.")
    parser.add_argument("--run-root", default=str(SCRIPT_DIR / "raw" / DEFAULT_RUN_ID))
    parser.add_argument("--reference", default=str(REPO_ROOT / "../data/real_reference/chm13v2_chr2.fa"))
